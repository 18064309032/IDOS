...
extern template Vec3d const Vec3d::UNDEFINED;
extern template Vec3f const Vec3f::UNDEFINED;
extern template Vec3i const Vec3i::UNDEFINED;
extern template Vec3st const Vec3st::UNDEFINED;
