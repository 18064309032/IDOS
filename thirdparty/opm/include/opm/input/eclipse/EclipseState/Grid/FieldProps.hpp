...
static const std::unordered_map<std::string, keyword_info<double>> double_keywords = {
    {"DISPERC",keyword_info<double>{}.unit_string("Length")},
    ...
    {"TPGOIL",  keyword_info<double>{}.unit_string("Pressure/Length").distribute_top(true).global_kw_until_edit()},
    {"TPGGAS",  keyword_info<double>{}.unit_string("Pressure/Length").distribute_top(true).global_kw_until_edit()},
    {"TPGWAT",  keyword_info<double>{}.unit_string("Pressure/Length").distribute_top(true).global_kw_until_edit()},
    {"SIGMAV",  keyword_info<double>{}.init(0.0).unit_string("1/Length*Length")},
    {"LX",      keyword_info<double>{}.unit_string("Length").distribute_top(true).global_kw_until_edit()},
    {"LY",      keyword_info<double>{}.unit_string("Length").distribute_top(true).global_kw_until_edit()},
    {"LZ",      keyword_info<double>{}.unit_string("Length").distribute_top(true).global_kw_until_edit()}
};
...
static const std::unordered_map<std::string, keyword_info<double>> composition_keywords = {
